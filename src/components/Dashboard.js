...
const Dashboard = () => {
    ...
    return (
        <>
            <form method='GET'>
                <div className="row">
                    <div className="col-sm-10"><h1>Student Dashboard</h1></div>
                    <div className="col-sm-2"><a href="home.html" className="pull-right"><img title="profile image" className="img-circle img-responsive" src={imgpath} /></a></div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-sm-3">
                            ...
                            <ul className="list-group">
                                ...
                                <li className="list-group-item text-right"><span className="pull-left"><strong>Room</strong></span>303</li>
                                <li className="list-group-item text-right"><span className="pull-left"><strong>Year</strong></span>SE</li>
                                <li className="list-group-item text-right"><span className="pull-left"><strong>Division</strong></span>I</li>
                                <li className="list-group-item text-right"><span className="pull-left"><strong>Roll No.</strong></span>21146</li>
                            </ul>
                                    ...
                                    <form className="form" action="##" method="post" id="registrationForm">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="col-xs-6">
                                                ...
                                                <input type="email" className="form-control" id="location" placeholder="address" title="enter a location" />
                                            </div>
                                        </div>
                                        <div className="form-group">
